...
public class PerfilResponsavelActivity extends AppCompatActivity {
            ...
            public void onResponse(Call<Usuario> call, Response<Usuario> response) {
                ...
                switch (menuItem)
                {
                    ...
                    case R.id.ic_home_perfil:
                        fragmentTransaction.replace(R.id.viewPagerCuidador, new HomeResponsavelFragment(usuario)).commit();
                        break;
                }
            }
